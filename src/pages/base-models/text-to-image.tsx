...
import {
  Button, Card, Input, UploadProps, UploadFile, message,
  Image, Slider, Row, Col, Select, Collapse, Divider, Upload,
} from "antd";
...
export default function TextToImage() {
  ...
  const [model, setModel] = useState<string>("text2img_v2");
                ...
                >
                  ...
                  <Collapse.Panel header="Generate Output" key="3">
                    <div>
                      ...
                      >
                        <Select.Option value="text2img_v2">
                          stable-diffusion-2-1
                        </Select.Option>
                        <Select.Option value="generate_1_5">
